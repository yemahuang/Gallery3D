...
public class CropImage extends MonitoredActivity {
    	...
    	if (cropValue != null) {
    		...
    		if (contentUri.startsWith("http://")) {
    			...
    			final ProgressDialog dialog = ProgressDialog.show(context, context.getResources().getString(R.string.initializing),
    					context.getResources().getString(Res.string.unknownName), true, false);
    			if (contentUri != null) {
    ...
    private void startFaceDetection() {
        ...
        Util.startBackgroundJob(this, null, getResources().getString(Res.string.unknownName), new Runnable() {
            public void run() {
