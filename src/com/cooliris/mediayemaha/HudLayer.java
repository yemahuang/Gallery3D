...
import com.cooliris.appyemaha.Res;
import com.cooliris.mediayemaha.MenuBar.Menu;
import com.cooliris.mediayemaha.PopupMenu.Option;
...
public final class HudLayer extends Layer {
    ...
    private void buildMoreOptions() {
        ...
        Option[] optionImageMultiple = new Option[] {
                new PopupMenu.Option(mContext.getResources().getString(R.string.rotate_left), mContext.getResources()
                        .getDrawable(R.drawable.ic_menu_rotate_left), new Runnable() {
                    public void run() {
                        mGridLayer.rotateSelectedItems(-90.0f);
                    }
                }),
                new PopupMenu.Option(mContext.getResources().getString(R.string.rotate_right), mContext.getResources()
                        .getDrawable(R.drawable.ic_menu_rotate_right), new Runnable() {
                    public void run() {
                        mGridLayer.rotateSelectedItems(90.0f);
                    }
                }), };
