...
import com.cooliris.cacheyemaha.CacheService;
import com.cooliris.wallpaperyemaha.RandomDataSource;
import com.cooliris.wallpaperyemaha.Slideshow;
...
public final class Gallery extends Activity {
    public static final String REVIEW_ACTION = "com.cooliris.mediayemaha.action.REVIEW";
        ...
        if (!mImageManagerHasStorageAfterDelay && mNumRetries < NUM_STORAGE_CHECKS) {
            if (mNumRetries == 1) {
                ...
                if (Environment.isExternalStorageRemovable()) {
                    res = R.string.no_sd_card;
                } else {
                    res = R.string.no_usb_storage;
                }
    ...
    public void onDestroy() {
        ...
        AlarmReceiver.sendGetAdMessage(Gallery.this);
    ...
    private void initializeDataSource() {
        ...
        if (!isPickIntent() && !isViewIntent() && !isReviewIntent()) {
            ...
            if (intent != null) {
                ...
                if (hasStorage) {
                    mApp.showToast(getResources().getString(R.string.pick_prompt), Toast.LENGTH_LONG);
                }
            }
