...
package com.cooliris.cacheyemaha;
...
import com.cooliris.appyemaha.App;
import com.cooliris.mediayemaha.DataSource;
import com.cooliris.mediayemaha.DiskCache;
import com.cooliris.mediayemaha.Gallery;
import com.cooliris.mediayemaha.LocalDataSource;
import com.cooliris.mediayemaha.LongSparseArray;
import com.cooliris.mediayemaha.MediaFeed;
import com.cooliris.mediayemaha.MediaItem;
import com.cooliris.mediayemaha.MediaSet;
import com.cooliris.mediayemaha.Shared;
import com.cooliris.mediayemaha.SortCursor;
import com.cooliris.mediayemaha.UriTexture;
import com.cooliris.mediayemaha.Utils;
public final class CacheService extends IntentService {
    public static final String ACTION_CACHE = "com.cooliris.cacheyemaha.action.CACHE";
    ...
    public static final String getCachePath(final String subFolderName) {
        return Environment.getExternalStorageDirectory() + "/Android/data/com.cooliris.mediayemaha/cache/" + subFolderName;
    }
    ...
    private static void syncCache(Context context) {
        if (!isCacheReady(true)) {
            ...
            if (context instanceof Gallery) {
                App.get(context).showToast(context.getResources().getString(R.string.cancel), Toast.LENGTH_LONG);
            }
            if (DEBUG)
            ...
            try {
                ...
                try {
                    if (sortCursor != null && sortCursor.moveToFirst()) {
                        ...
                        cameraSet.mName = context.getResources().getString(R.string.cancel);
                        sets.add(cameraSet);
